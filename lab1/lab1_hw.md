...
GitHub is a service that allows people to create repositories in order to organize, store and maintain their work done on coding programs like RStudio.
...
I assumed, due to order of operations, that the answer to the second equation would be 8 not 2. This shows that putting two ** completes the function twice.
