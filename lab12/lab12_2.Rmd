...
ui <- fluidPage(titlePanel("Log 10 Homerange by Taxon"),
                radioButtons("x", "Select Taxon", choices=c("birds", "lake fishes", "mammals", "marine fishes", "river fishes", "snakes", "tortoises", "turtles"), selected="birds"),
                plotOutput("plot", width="600px", height="500px")
)
...
server <- function(input, output, session) {
  output$plot <- renderPlot({
    homerange %>%
      ...
      geom_density(fill="plum", color="black", alpha=0.6)
  })
