...
ui <- fluidPage(titlePanel("Sexual Composition of Wolfpacks by Population"),
                radioButtons("x", "Select Fill Variable", choices=c("AK.PEN", "BAN.JAS", "BC", "DENALI", "ELLES", "GTNP", "INT.AK", "MEXICAN", "MI", "MT", "N.NWT", "ONT", "SE.AK", "SS.NWT", "YNP", "YUCH"),
                             selected="AK.PEN"),
                plotOutput("plot")
