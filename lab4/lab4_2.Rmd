...
```{r}
updated_mammals <- select(mammals, -order, -newborn, -weaning, -wean_mass, -AFR, -max_life, -litter_size, -litters_per_year)
updated_mammals
```

5. Use the output from #4 to focus on the family Bovidae with a mass greater than 450000.
```{r}
filter(updated_mammals, mass<450000, family== "Bovidae")
```
