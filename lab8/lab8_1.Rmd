...
(2) each observation has its own row?  
switched - maybe heart rate should be in rows and people should be columns?? 
...
should be a column called income - current variables are data
